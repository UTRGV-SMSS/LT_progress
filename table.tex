...
\\
\ifthenelse{\value{gradeCrowII}=4}
    {\foreach \n in {1,...,4}{\bxi}}
    {
...
\\
\ifthenelse{\value{gradeCrowIII}=2}
    {\foreach \n in {1,...,2}{\bxi}}
    {
...
Optional\\
\ifthenelse{\equal{\value{gradeArowII}}{3}}
    {\foreach \n in {1,...,3}{\bxi}}
    {
